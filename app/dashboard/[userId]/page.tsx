...
// // import TanstackTableWidget from "@/components/widgets/table/advanceTable/FullyResponsiveTanStackTable";
...
// //       margin: 0, // Removed margin to eliminate extra spaces
// //     },
// //     "& .react-grid-item": {
...
// // type WidgetType = "chart" | "advanced-table" | "basic-table" | "adv-table" | "data-grid";
...
// // const WidgetFactory: React.FC<{ widget: Widget; onRemove: (id: string) => void }> = ({ widget, onRemove }) => {
...
// //   return <div className="widget-wrapper" style={{ minHeight: "100%", backgroundColor: "transparent" }}>
// //     {renderWidget()}
// //   </div>
// // };
...
// //                     <div style={{ flex: 1 }}>
// //                       <Text weight="semibold" size={400}>{cat.name}</Text>
...
// //           y: Infinity, // Auto-place at the bottom
// //           w: 6,
// //           h: 5,
// //         },
// //       };
...
// //           <Text size={400} weight="semibold">Loading your dashboard...</Text>
// //         </div>
// //       </div>
// //     );
// //   }
...
// //               rowHeight={60} // Consistent row height to avoid extra space
// //               isDraggable={true}
// //               isResizable={true}
// //               draggableHandle=".widget-drag-handle"
// //               margin={[0, 0]} // Removed margin to eliminate extra spaces
// //               containerPadding={[0, 0]} // Removed padding to fit widgets tightly
// //               compactType="vertical" // Compacts widgets vertically to remove gaps
// //               preventCollision={false}
// //               useCSSTransforms={true}
// //               resizeHandles={["se"]} // Enable southeast resize handle
// //               isBounded={false}
// //             >
// //               {widgets.map((widget) => (
// //                 <div key={widget.id}>
...
// import { Responsive, WidthProvider, type Layout } from "react-grid-layout"
// import { useParams } from "next/navigation"
// import { ChartWidget, PremiumTableWidget } from "@/components/widgets"
// import TanstackTableWidget from "@/components/widgets/table/advanceTable/FullyResponsiveTanStackTable"
...
//   return (
//     <div className="widget-wrapper" style={{ minHeight: "100%", backgroundColor: "transparent" }}>
//       {renderWidget()}
//     </div>
//   )
// }
...
import FullyResponsiveFluentTable from "@/components/widgets/table/advanceTable/FullyResponsiveTanStackTable";
